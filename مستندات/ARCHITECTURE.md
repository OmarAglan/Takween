...
4. **Command Executor** (`المصدر/منفذ_الأوامر.baa`)
...
- `حل_الاعتماديات.baa`
  - حل اعتماديات path/Git المتعدية وجمع مصادرها وتضميناتها في خطة Baa.
...
- v1 التنفيذي الحالي يفهرس عدة أهداف، ويختار build/check/run بالاسم، ويشغل هدف
  اختبار واحدا أو كل أهداف الاختبار، ويحل path/Git ويكتب lock. تبقى globs وبناء
  المكتبة المستقلة وSemVer/registry/archive hashing لاحقا.
