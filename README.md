...
والأعلام وتجزئات المصادر والرؤوس و`تكوين.قفل`. يعيد Baa استخدام الكائنات؛ يبقى
الربط منفذا ومعلنا، ولا تسجل وحدات نظم غير القابلة للكاش إصابة زائفة. تفاصيل
العقد في [`مستندات/CONTENT_CACHE_V1.md`](مستندات/CONTENT_CACHE_V1.md).
